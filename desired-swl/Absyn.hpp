...
class Expr : public swl::variant<Variable, Application, Abstraction, StringExpr, IntegerExpr, DoubleExpr, CharExpr, SpecialExpr> {
public:
...
class Program : public swl::variant<AProgram> {
public:
    using variant::variant;
    inline class AProgram& AProgram() {
        return swl::get<class AProgram>(*this);
    }
